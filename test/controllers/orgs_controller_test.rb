...
class OrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post orgs_url, params: { org: { description_display: @org.description_display, name: @org.name } }
    end
  ...
  test "should update org" do
    patch org_url(@org), params: { org: { description_display: @org.description_display, name: @org.name } }
